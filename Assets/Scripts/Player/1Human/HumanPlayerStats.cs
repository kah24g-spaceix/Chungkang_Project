...
public class HumanPlayerStats : MonoBehaviour, IPlayerStats
{
    ...
    private HumanMovementComponent _movement;
    private HumanAttackComponent _attack;

    private void Awake()
    {
        _movement = GetComponent<HumanMovementComponent>();
        _attack = GetComponent<HumanAttackComponent>();
    }
    private void Start()
    {
